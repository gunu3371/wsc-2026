resource "aws_s3_object" "dockerfile" {
  ...
  source       = "${path.module}/../../assets/foundation/Dockerfile"
  etag         = filemd5("${path.module}/../../assets/foundation/Dockerfile")
...
resource "aws_s3_object" "book_binary" {
  ...
  source = "${path.module}/../../assets/foundation/book"
  etag   = filemd5("${path.module}/../../assets/foundation/book")
}
